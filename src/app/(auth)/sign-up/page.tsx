...
export default function SignUpForm() {
  ...
  return (
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <Input
                          ...
                          className="bg-transparent border-b border-white focus:outline-none focus:border-blue-500 text-white placeholder-white"
                        />
    ...
    <Navbar/>
    <div className="flex justify-center items-center min-h-screen bg-black">
      <div className="w-full max-w-md p-8 rounded-lg shadow-2xl bg-gray-800 backdrop-blur-md">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            />
            <Button type="submit" className='w-full bg-default hover:bg-orange-800 text-white' disabled={isSubmitting}>
              {isSubmitting ? (
                <>
                  <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                  Please wait
